...
export function CardEvent({ title, imageUrl, date, id }) {
  return (
    <Link to={`./${id}`}>
      <div className=" cursor-pointer group relative items-center justify-center overflow-hidden transition-shadow shadow-xl shadow-black/30 rounded-2xl">
